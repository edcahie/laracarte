            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="www.laravel.com">Laravel.com</a></li>
                        <li><a href="laravel.io">Laravel.io</a></li>
                        <li><a href="Laravel.com">Laracasts</a></li>
                        <li><a href="Laravel.com">Larajobs</a></li>
                        <li><a href="Laravel.com">Laravel News</a></li>
                        <li><a href="Laravel.com">Larachat</a></li>
